...
class ControllerModuleOcsearchcategory extends Controller {
    ...
    public function index() {
        ...
        $data['search_action'] = $this->url->link('product/search', '', 'SSL');
        $data['search_ajax_action'] = $this->url->link('module/ocsearchcategory/ajaxSearch', '', 'SSL');
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/ocsearchcategory/ocsearchcategory.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/module/ocsearchcategory/ocsearchcategory.tpl', $data);
        } else {
            return $this->load->view('default/template/module/ocsearchcategory/ocsearchcategory.tpl', $data);
        }
    }
    ...
    public function ajaxSearch() {
        ...
        if(($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/ocsearchcategory/searchajaxresult.tpl')) {
                $json['result_html'] = $this->load->view($this->config->get('config_template') . '/template/module/ocsearchcategory/searchajaxresult.tpl', $data);
            } else {
                $json['result_html'] = $this->load->view('default/template/module/ocsearchcategory/searchajaxresult.tpl', $data);
            }
