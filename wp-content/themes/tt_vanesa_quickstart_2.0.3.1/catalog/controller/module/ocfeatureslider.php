...
class ControllerModuleOcfeatureslider extends Controller {
	public function index($setting) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/slideshow.css')) {
			...
			$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/opentheme/featuredslider.css');
			$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/opentheme/css/owl.theme.css');
			
			
		} else {
			$this->document->addStyle('catalog/view/theme/default/stylesheet/opentheme/featuredslider.css');
			$this->document->addStyle('catalog/view/theme/default/stylesheet/opentheme/css/owl.theme.css');
