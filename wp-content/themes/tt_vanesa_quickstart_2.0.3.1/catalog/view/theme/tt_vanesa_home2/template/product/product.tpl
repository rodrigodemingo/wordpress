  ...
  <div class="row"><?php echo $column_left; ?>
	...
	<div class="product-view">
      <div class="row">
        ...
        <?php $class = 'col-md-6 col-sm-6 col-sms-12 col-xs-12 view-zoom'; ?>
        <?php } else { ?>
        <?php $class = 'col-md-4 col-sm-12 col-sms-12'; ?>
        <?php } ?>
       <div class="<?php echo $class; ?>">
			<div class="image-block">
				...
				<div class="price">
					...
					<?php echo $price; ?>
					<?php } else { ?>
					<span class="line-through" style="text-decoration: line-through;"><?php echo $price; ?></span>
					<?php echo $special; ?>
					<?php } ?>
        ...
        <?php $class = 'col-md-6 col-sm-6 col-sms-12 col-xs-12'; ?>
        <?php } else { ?>
        <?php $class = 'col-md-8 col-sm-12 col-sms-12'; ?>
        <?php } ?>
        <div class="<?php echo $class; ?>">
		...
		<?php } ?>
          ...
          <?php if ($review_status) { ?>
			<div class="acction">
				<div class="btn-group">
					<button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" ><span><i class="fa fa-shopping-cart"></i><?php echo $button_cart; ?></span></button>
					<button type="button" id="wishlist" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><span><i class="fa fa-heart"></i><?php echo $button_wishlist; ?></span></button>
				</div>
			</div>
          <div class="rating">
            <p>
