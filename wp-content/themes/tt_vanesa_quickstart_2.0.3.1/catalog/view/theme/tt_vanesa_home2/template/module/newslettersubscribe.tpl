<div id="boxes" class="newletter-container col-sm-8 col-md-8 col-sms-12">
		  ...
		  <div id="frm_subscribe">
			  <form name="subscribe" id="subscribe">
				   <?php if(!$thickbox) { ?> style="display:none" <?php } ?>
						 <input type="text" value="" name="subscribe_name" id="subscribe_name">
						<a class="button" onclick="email_subscribe()"><!-- <i class="fa fa-chevron-right"></i> --><span><?php echo $entry_button; ?></span></a>
