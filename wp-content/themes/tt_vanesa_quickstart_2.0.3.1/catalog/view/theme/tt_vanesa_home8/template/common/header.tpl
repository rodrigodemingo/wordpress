...
<?php 
 ...
 ?>
   <link rel="stylesheet" type="text/css" href="catalog/view/theme/tt_vanesa_home8/stylesheet/global.css" />
   <?php
 } else {
 ?>
...
<link href="catalog/view/theme/tt_vanesa_home8/stylesheet/animate.css" rel="stylesheet" type="text/css">
<link href="catalog/view/theme/tt_vanesa_home8/stylesheet/opentheme/hozmegamenu/css/custommenu.css" rel="stylesheet">
<link href="catalog/view/theme/tt_vanesa_home8/stylesheet/opentheme/ocsearchcategory.css" rel="stylesheet">
<link href="catalog/view/theme/tt_vanesa_home8/stylesheet/opentheme/ocslideshow/ocslideshow.css" rel="stylesheet">
<link href="catalog/view/theme/tt_vanesa_home8/stylesheet/opentheme/vermegamenu/css/ocsvegamenu.css" rel="stylesheet">
<link href="catalog/view/theme/tt_vanesa_home8/stylesheet/opentheme/categorytabslider.css" rel="stylesheet">
<link href="catalog/view/theme/tt_vanesa_home8/stylesheet/opentheme/oclayerednavigation/css/oclayerednavigation.css" rel="stylesheet">
...
<link href="catalog/view/theme/tt_vanesa_home8/stylesheet/opentheme/css/owl.carousel.css" rel="stylesheet">
...
<?php } ?>
<script src="catalog/view/javascript/common_home7.js" type="text/javascript"></script>
...
<div class="container">
  ...
  <div class="row">
	...
	<div class="header-cart col-xs-12 col-md-9 col-sm-12">
		<div class="header-search"><?php if(isset($content_block5)) { echo $content_block5; } ?></div>
		<div class="top-cart">
			<?php echo $cart; ?>
		</div>
	</div>
...
<div class="menu">
	<div class="container">
		<div class="menu-container">
			<?php if(isset($content_block)) { echo $content_block; } ?>
		</div>
	</div>
</div>
<?php if(isset($content_block2)) { echo $content_block2; } ?>
<?php if ($categories) { ?>
<?php } ?>
