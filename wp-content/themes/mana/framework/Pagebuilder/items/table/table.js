    ...
    jQuery('.blox_table').each(function(){
        ...
        .click(function(){
            ...
            var table_html = '<p> \
                                ...
                                [ <b>Default Row</b> ] you can add here any type of content including html code as ul li elements.<br> \
                                [ <b>Pricing Row</b> ] you should add your content as this structure. Price,Currency,Time Ex: <em>5,$,montly</em><br> \
                                [ <b>Button Row</b> ] you should add your button text and link as this format. Link text + comma (,) + url. Ex: <em>Purchase now,http://themeforest.net</em><br> \
                                [ <b>Description Column</b> ] you should add bunch text on default row.\
            ...
            var row_action = '<div class="blox_display_cell cell_row_action"> \
		  								<a href="javascript:;" class="icon-times"></a> \
		  							</div>';
