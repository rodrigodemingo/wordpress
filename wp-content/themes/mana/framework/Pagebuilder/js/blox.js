...
function switch_blox_builder(switcher){
	...
	if(switcher){
		...
		jQuery("#postdivrich").addClass('disappear-mode');
		...
		jQuery("#postdivrich").removeClass('disappear-mode');
...
jQuery(function(){
	...
	jQuery('#blox_fullscreen').on('click', function(){
	...
	jQuery('#blox_trigger_publish').on('click', function(){
		jQuery('#publish').trigger('click');
	});
