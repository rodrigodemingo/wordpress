...
require_once file_require( get_template_directory() . '/framework/widgets/post_format_widget.php' );
require_once file_require( get_template_directory() . '/framework/widgets/recent_portfolio_widget.php' );
?>