...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function notices() {
            // edit for porto theme
            if ( Porto()->is_registered() == '1' || $this->is_tgmpa_page() || get_user_meta( get_current_user_id(), 'tgmpa_dismissed_notice_' . $this->id, true ) || ! current_user_can( 'edit_theme_options' ) ) {
                return;
            }
