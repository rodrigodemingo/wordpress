...
function shopkit_material_general_settings( $custom_settings ) {

$custom_settings['settings']['logo_image']['std'] = preg_replace( '(^https?:)', '', esc_url( untrailingslashit( get_template_directory_uri() ) ) . '/demos/material/images/logo.png' );
...
add_filter( 'shopkit_material_general_settings_args', 'shopkit_material_general_settings' );


function shopkit_material_section_header_settings( $custom_settings ) {
...
add_filter( 'shopkit_material_section_header_args', 'shopkit_material_section_header_settings' );


function shopkit_material_section_footer_settings( $custom_settings ) {
...
add_filter( 'shopkit_material_section_footer_args', 'shopkit_material_section_footer_settings' );


function shopkit_material_section_menu_bar_settings( $custom_settings ) {
...
add_filter( 'shopkit_material_section_menu_bar_args', 'shopkit_material_section_menu_bar_settings' );


function shopkit_material_section_top_bar_settings( $custom_settings ) {
...
add_filter( 'shopkit_material_section_top_bar_args', 'shopkit_material_section_top_bar_settings' );


function shopkit_material_section_footer_bar_settings( $custom_settings ) {
...
add_filter( 'shopkit_material_section_footer_bar_args', 'shopkit_material_section_footer_bar_settings' );


function shopkit_material_section_shop_information_settings( $custom_settings ) {
...
add_filter( 'shopkit_material_section_shop_information_args', 'shopkit_material_section_shop_information_settings' );


function shopkit_material_section_shop_widgets_settings( $custom_settings ) {
...
add_filter( 'shopkit_material_section_shop_widgets_args', 'shopkit_material_section_shop_widgets_settings' );

function shopkit_material_activate() {
...
add_action( 'after_switch_theme', 'shopkit_material_activate' );
