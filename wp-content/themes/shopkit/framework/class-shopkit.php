<?php
	...
	class ShopKit {
		...
		public static function add_scripts() {
			...
			wp_register_script( 'shopkit-load', WcSk()->template_url() . '/framework/js/shopkit-load.js', array( 'jquery', 'wp-util' ), WcSk()->version(), true );
...
<?php
		...
		public static function get_archive_description() {
			...
			$desc = wp_kses_post( term_description() );
