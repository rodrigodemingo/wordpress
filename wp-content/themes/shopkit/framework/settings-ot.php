	...
	class ShopKit_Ot_Settings {
		...
		public static function ot_add_scripts() {
			...
			if ( substr( get_current_screen()->id, 0, 24 ) == 'appearance_page_shopkit-' ) {
				...
				wp_enqueue_style( 'shopkit-confirm', WcSk()->template_url() . '/framework/css/jquery-confirm.css' );
				wp_enqueue_style( 'shopkit-less', WcSk()->template_url() . '/framework/css/shopkit-ot.css' );

				wp_register_script( 'shopkit-jquery-confirm', WcSk()->template_url() . '/framework/js/jquery-confirm.js', array( 'jquery' ), WcSk()->version(), true );
				...
				wp_enqueue_script( 'shopkit-jquery-confirm' );
				...
				$args = array(
					...
					'locale' => array(
						...
						'demo_complete' => esc_html__( 'Finished! Page will refresh!', 'shopkit' ),
