...
<table class="shop_table shop_table_responsive1 cart data-table cart-table" id="shopping-cart-table" cellspacing="0">
    <thead>
        <tr>
            <th>&nbsp;</th>
                    ...
                    <td><h2 class="product-name">
                        ...
                        <?php
                            echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
                                '<a href="%s" class="button remove-item" title="%s" data-product_id="%s" data-product_sku="%s"></a>',
    ...
    <tr class="first last">
                ...
                <button type="submit" class="button btn-update" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'woocommerce' ); ?>" />
                <span><?php esc_attr_e('Update Cart', 'woocommerce'); ?></span></button>
