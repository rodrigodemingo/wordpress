            ...
            <div class="home-block-inner">
              <div class="block-title">
               ...
               <div class="pretext">
                 ...
                 <?php echo htmlspecialchars_decode($creta_Options['enable_home_featured_products-text']);?>
               </div>
            ...
            <div class="home-block-inner">
             <div class="block-title">
              <h2><?php esc_attr_e('Best', 'creta'); ?><br>
                  <em> <?php esc_attr_e('Sellers', 'creta'); ?></em></h2>
                 
              </div>
              <div class="pretext">
                 <?php echo htmlspecialchars_decode($creta_Options['home_bestseller_products-text']);?>
               </div>
                      ...
                      <li>
                                    <?php if (class_exists('YITH_WCQV_Frontend')) { ?>
                                       <a class="yith-wcqv-button link-quickview" href="#"
                                        data-product_id="<?php echo esc_html($product->id); ?>"><?php esc_attr_e('Quick View', 'creta'); ?></a>
                                     <?php } ?>
                      </li>
                      <li>
                                        <?php
