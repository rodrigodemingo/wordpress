...
class WPEX_TL_Posttype {
	...
	function register_metadata(array $meta_boxes){
		...
		$custom_date = array(
			array( 'id' => 'wpex_sublabel',  'name' => esc_html__('Sub label','wp-timeline'), 'cols' => 3, 'type' => 'text','allow_none' => true, 'desc' => esc_html__('Enter Sub label', 'exthemes'), 'sortable' => false, 'repeatable' => false ),
			array( 'id' => 'wpex_date',  'name' => esc_html__('Custom Date','wp-timeline'), 'cols' => 5, 'type' => 'text','allow_none' => true, 'desc' => esc_html__('Ex: 19 02 1945 or 19/02/1945', 'wp-timeline'), 'sortable' => false, 'repeatable' => false ),
		);
