...
class EXC_MB_Select extends EXC_MB_Field {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'select2', trailingslashit( EXC_MB_URL ) . 'js/vendor/select2/select2.js', array( 'jquery' ) );
		wp_enqueue_script( 'field-select', trailingslashit( EXC_MB_URL ) . 'js/field.select.js', array( 'jquery', 'select2', 'exc_mb-scripts' ) );
	}
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'select2', trailingslashit( EXC_MB_URL ) . 'js/vendor/select2/select2.css' );
	}
