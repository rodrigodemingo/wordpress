	...
	if($layout=='horizontal' || $layout=='hozsteps'){
		...
		if($the_query->have_posts()){
			...
			if(1==2){
				?>
				<style type="text/css">
					#slider-tl-<?php echo esc_attr($ID)?>.wpex-tl-vertical .wpex-point .tl-date:after,
					#slider-tl-<?php echo esc_attr($ID)?>.wpex-tl-vertical .wpex-point .tl-date:before{background-image: none !important;}
				</style>
			<?php
			}
