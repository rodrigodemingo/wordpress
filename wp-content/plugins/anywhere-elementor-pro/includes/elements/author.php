    ...
    protected function register_avatar_style_controls(){
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ae-element-avatar a img',
                'condition' => [
                    'render_data' => 'avatar'
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .ae-element-avatar a img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
    ...
    protected function render_author_meta_style_controls(){
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ae-author-meta-wrapper a',
                'condition' => [
                    'render_data!' => ['avatar'],
                ],
            ]
