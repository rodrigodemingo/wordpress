...
class Aepro_Post_Meta extends Widget_Base{
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ae-element-post-tag a:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render_date($p,$settings,$attribute_string){
        ...
        <div <?php echo $attribute_string; ?>>
            ...
            <?php } ?>
            <a href="#" <?php echo $this->get_render_attribute_string( 'post-date-class' ); ?>>
                <?php echo $post_date; ?>
            </a>
        </div>
        <?php
    ...
    protected function render_author($p,$settings,$attribute_string){
        ...
        <div <?php echo $attribute_string; ?>>
            ...
            <a href="<?php echo $author_link;?>" <?php echo $this->get_render_attribute_string('post-author-class'); ?>><?php echo $post_author_name; ?></a>
        </div>
        <?php
        return true;
    }
