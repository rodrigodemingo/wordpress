...
abstract class Skin_Base extends Elementor_Skin_Base
{
    ...
    protected function swiper_html(){
        ...
        print_r(json_encode($slide_per_view, JSON_NUMERIC_CHECK));
                    ...
                    <div class="ae-grid">
                        ...
                        <figure class="ae-grid-item">
                            <div class="ae-grid-item-inner">
                                <a href="<?php echo $image['url']; ?>" data-elementor-lightbox-slideshow="<?php echo $this->parent->get_id(); ?>">
                                    <img src="<?php echo $src;  ?>" />
                                    <div class = "ae-grid-overlay <?php echo $animation ?>">
                                        <div class="ae-grid-overlay-inner">
                                            <div class="ae-icon-wrapper">
                                            <?php if(!empty($icon)){ ?>
                                                <div class="ae-overlay-icon"><i class="<?php echo $icon ?>"> </i> </div>
                                            <?php } ?>
                                            </div>
