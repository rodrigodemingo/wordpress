...
class Admin{
    ...
    const AEPRO_PLUGIN_SECRET_KEY = '58984c2e68e5a2.36558253';
...
define('AEPRO_PLUGIN_LICENSE_SERVER_URL', 'http://api.webtechstreet.com'); //Rename this constant name so it is specific to your plugin or theme.
