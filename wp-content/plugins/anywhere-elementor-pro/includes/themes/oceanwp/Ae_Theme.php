...
class Ae_Theme{
    ...
    function load_archive_template($template_include){
        ...
        if(is_archive() || ($this->_page_type == 'blog')){
            if($this->_override == 'partial'){
                $template_include = AE_PRO_PATH . 'includes/themes/oceanwp/archive.php';
            }else{
                if($this->_use_canvas){
                    $template_include = AE_PRO_PATH . 'includes/themes/canvas-archive.php';
                }else{
                    $template_include = AE_PRO_PATH . 'includes/themes/oceanwp/archive-full.php';
                }
        ...
        if(is_404()){
            if($this->_use_canvas){
                ...
                $template_include = AE_PRO_PATH . 'includes/themes/oceanwp/404.php';
    ...
    function load_single_template($single_template){
        $single_template = AE_PRO_PATH . 'includes/themes/oceanwp/single.php';
