        ...
        if ( ('section' === $element->get_name() && 'section_background' === $section_id) || ('column' === $element->get_name() && 'section_style' === $section_id)) {
            ...
            $element->add_control(
                ...
                [
                    ...
                    'type'          => Controls_Manager::SELECT,
                    'options' => [
                        '' => _x( 'Default', 'Background Control', 'ae-pro' ),
                        'top left' => _x( 'Top Left', 'Background Control', 'ae-pro' ),
                        'top center' => _x( 'Top Center', 'Background Control', 'ae-pro' ),
                        'top right' => _x( 'Top Right', 'Background Control', 'ae-pro' ),
                        'center left' => _x( 'Center Left', 'Background Control', 'ae-pro' ),
                        'center center' => _x( 'Center Center', 'Background Control', 'ae-pro' ),
                        'center right' => _x( 'Center Right', 'Background Control', 'ae-pro' ),
                        'bottom left' => _x( 'Bottom Left', 'Background Control', 'ae-pro' ),
                        'bottom center' => _x( 'Bottom Center', 'Background Control', 'ae-pro' ),
                        'bottom right' => _x( 'Bottom Right', 'Background Control', 'ae-pro' ),
                    ],
                    'selectors' => [
            ...
            $element->add_control(
                ...
                [
                    ...
                    'options' => [
                        '' => _x( 'Default', 'Background Control', 'ae-pro' ),
                        'scroll' => _x( 'Scroll', 'Background Control', 'ae-pro' ),
                        'fixed' => _x( 'Fixed', 'Background Control', 'ae-pro' ),
                    ],
                    'selectors' => [
            ...
            $element->add_control(
                ...
                [
                    ...
                    'options' => [
                        '' => _x( 'Default', 'Background Control', 'ae-pro' ),
                        'no-repeat' => _x( 'No-repeat', 'Background Control', 'ae-pro' ),
                        'repeat' => _x( 'Repeat', 'Background Control', 'ae-pro' ),
                        'repeat-x' => _x( 'Repeat-x', 'Background Control', 'ae-pro' ),
                        'repeat-y' => _x( 'Repeat-y', 'Background Control', 'ae-pro' ),
                    ],
                    'selectors' => [
