			...
			<div class="ts-vcsc-section-content">
				<div style="margin-top: 10px;">
					...
					<div class="" style="display: inline-block; margin: 0 5px 0 0; width: 200px;">
						<a class="ts-vcsc-image-link" style="display: block; width: 100%; margin: 0; text-align: center; text-decoration: none;" href="http://www.composium.krautcoding.com/documentation/" target="_blank">
							<img src="<?php echo TS_VCSC_GetResourceURL('images/other/composium_manual.png'); ?>" style="width: 100%; height: auto; margin-right: 10px;">
						</a>
					</div>
					<div class="" style="display: inline-block; margin: 0 5px 0 0; width: 200px;">
						<a class="ts-vcsc-image-link" style="display: block; width: 100%; margin: 0; text-align: center; text-decoration: none;" href="http://helpdesk.krautcoding.com/forums/forum/wordpress-plugins/visual-composer-extensions/" target="_blank">
					...
					<div class="" style="display: none; margin: 0 5px 0 0; width: 200px;">
						<a class="ts-vcsc-image-link" style="display: block; width: 100%; margin: 0; text-align: center; text-decoration: none;" href="http://helpdesk.krautcoding.com/changelog-composium-visual-composer-extensions/" target="_blank">
