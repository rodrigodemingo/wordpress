	...
	<div class="ts-vcsc-section-main">
		...
		<div class="ts-vcsc-section-content">
			...
			<div>
				...
				<div class="ts-switch-button ts-composer-switch" data-value="<?php echo ($ts_vcsc_extend_settings_loadHammerNew == 1 ? 'true' : 'false'); ?>" data-width="80" data-style="compact" data-on="Yes" data-off="No" style="float: left; margin-right: 10px;">
					<input type="checkbox" style="display: none; " id="ts_vcsc_extend_settings_loadHammerNew" class="toggle-check ts_vcsc_extend_settings_loadHammerNew" name="ts_vcsc_extend_settings_loadHammerNew" value="1" <?php echo checked('1', $ts_vcsc_extend_settings_loadHammerNew); ?>/>
					<div class="toggle toggle-light" style="width: 80px; height: 20px;">
						<div class="toggle-slide">
							<div class="toggle-inner">
								<div class="toggle-on <?php echo ($ts_vcsc_extend_settings_loadHammerNew == 1 ? 'active' : ''); ?>">Yes</div>
								<div class="toggle-blob"></div>
								<div class="toggle-off <?php echo ($ts_vcsc_extend_settings_loadHammerNew == 0 ? 'active' : ''); ?>">No</div>
							</div>
						</div>
					</div>
				</div>
				<label class="labelToggleBox" for="ts_vcsc_extend_settings_loadHammerNew">Load v2.x Release of Hammer.js</label></span>
			</div>		
			<hr class='style-six' style='margin-top: 20px;'>				
			<div>
			...
			<div>
				...
				<p style="font-size: 12px; text-align: justify;">Please define if you want to load the Waypoints File for Viewport Animations; preventing that file from being loaded via this option will also prevent Visual Composer itself from loading it, so ensure that the file is in fact already loaded by your theme or another plugin:</p>
