	...
	<div class="ts-vcsc-section-main">
		...
		<div class="ts-vcsc-section-content">
			...
			<div>
				...
				<?php
					$settings = array(
						"param_name"        => "ts_vcsc_extend_settings_loadModernizr",
						"label"				=> "Load Modernizr Script",
						"value"             => $ts_vcsc_extend_settings_loadModernizr,
						"order"				=> 1,
					);
					echo TS_VCSC_CodeStarButton_Settings_Field($settings, $ts_vcsc_extend_settings_loadModernizr);
				?>
			</div>		
			<hr class='style-six' style='margin-top: 20px;'>				
			<div>
			...
			<div style="<?php echo ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_UseEnlighterJS == "true" ? "" : "margin-bottom: 10px;") ?>;">
				...
				<?php
					$settings = array(
						"param_name"        => "ts_vcsc_extend_settings_loadCountTo",
						"label"				=> "Load CountTo Script",
						"value"             => $ts_vcsc_extend_settings_loadCountTo,
						"order"				=> 1,
					);
					echo TS_VCSC_CodeStarButton_Settings_Field($settings, $ts_vcsc_extend_settings_loadCountTo);
				?>
			</div>
