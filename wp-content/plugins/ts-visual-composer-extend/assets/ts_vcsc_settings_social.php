		...
		<div class="ts-vcsc-section-content">
			...
			<div>
				...
				<div class="ts-advanced-link-button-wrapper ts-advanced-link-tooltip-holder" style="margin: 20px 0;">
					<span class="ts-advanced-link-tooltip-content"><?php _e("Click here to either restore the initial default order, or to sort social networks alphabetically.", "ts_visual_composer_extend"); ?></span>
					<button type="button" id="ts-vcsc-social-network-links-restore" class="ts-advanced-link-button-main ts-advanced-link-button-silver ts-advanced-link-button-sort" style="margin: 0;">
						<?php echo __("Change Order", "ts_visual_composer_extend"); ?>
					</button>
				</div>			
			</div>			
			<?php
