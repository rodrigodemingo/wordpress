<?php
	...
	if (!defined('TS_VCSC_NOTIFIER_PLUGIN_XML_FILE')){
		define('TS_VCSC_NOTIFIER_PLUGIN_XML_FILE', 				'http://www.maintenance.krautcoding.com/notifications/ts-notify-vc-extensions-wp.xml');
	}
						...
						echo '<div class="ts-vcsc-section-content">';
							...
							echo '<div style="text-align: justify; margin-bottom: 20px;">';
								if ((string) $xml->latest <= (string) $xml->forum) {
									...
									echo '<div>To download the updated version, login to our <a href="http://helpdesk.krautcoding.com/" target="_blank"">Support Forum</a>, head over to the <a href="http://helpdesk.krautcoding.com/freebies-page/" target="_blank">Downloads</a> page and download the plugin update from the provided listing of plugin releases.
