...
<div id="ts-settings-language" class="tab-content">
    ...
    <div class="ts-vcsc-section-main">
		...
		<div class="ts-vcsc-section-content slideFade" style="display: none;">
			...
			<p style="margin-top: 10px;">
				<label class="Uniform" style="display: inline-block;" for="ts_vcsc_extend_settings_languagePlyrPlayerCurrentYime">"<?php _e($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Plyr_Player_Language_Defaults['currenttime']); ?>":</label>
				<input class="validate[required]" data-error="Text - <?php _e($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Plyr_Player_Language_Defaults['currenttime']); ?>" data-order="10" type="text" style="width: 20%;" id="ts_vcsc_extend_settings_languagePlyrPlayerCurrentYime" name="ts_vcsc_extend_settings_languagePlyrPlayerCurrentYime" value="<?php echo (isset($TS_VCSC_PlyrVideo_Language['currenttime']) ? $TS_VCSC_PlyrVideo_Language['currenttime'] : $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Plyr_Player_Language_Defaults['currenttime']); ?>" size="100">
			</p>
			<p style="margin-top: 10px;">
