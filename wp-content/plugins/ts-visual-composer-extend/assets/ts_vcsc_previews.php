...
<div class="ts-vcsc-settings-group-header">
	<div class="display_header">
		<h2><span class="dashicons dashicons-visibility"></span>Composium - Visual Composer Extensions v<?php echo TS_VCSC_GetPluginVersion(); ?> ... Icon Font Previews</h2>
	</div>
	<div class="clear"></div>
</div>
				...
				<div id="ts_vcsc_preview_container">
					<div style="width: 100%; display: inline-block; margin-bottom: 20px; border-bottom: 1px solid #DDDDDD; padding-bottom: 20px;">
						...
						<div style="width: 100%; margin: 0; padding: 0; display: block;">
							<div class="ts-advanced-link-button-wrapper ts-advanced-link-tooltip-holder" style="margin: 10px 0 0 0; <?php echo ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Active_Icon_Fonts > 1 ? "display: inline-block;" : "display: none;"); ?>">
								<span class="ts-advanced-link-tooltip-content"><?php _e("Click here to switch between any of the activated icon fonts.", "ts_visual_composer_extend"); ?></span>
								<button type="button" name="Dropdown" id="ts-settings-statistics-compile-trigger" data-dropdown="#ts-dropdown-fonts" class="dropDownFont ts-advanced-link-button-main ts-advanced-link-button-turquoise ts-advanced-link-button-menu">
									<?php _e("Switch Icon Font", "ts_visual_composer_extend"); ?>
								</button>											
