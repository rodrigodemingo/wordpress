	...
	<div class="ts-vcsc-icon-generator-wrap" style="margin-top: 0px;">
		...
		<div class="ts-vcsc-section-main">
			...
			<div class="ts-vcsc-section-content">
				...
				<div id="ts_tiny_generator_container" style="border: none; padding: 10px; margin-top: 0px; margin-bottom: 0px;">
							...
							<table id="ts_tiny_tinymce_table_icon" class="ts_tiny_form ts_tiny_table ts_tiny_tinymce_table_icon" cellspacing="0" style="">
								<?php
									...
									$output .= '<tr>';
										...
										$output .= '<td class="ts-switch-button ts-composer-switch">';
											$output .= '<div id="ts-tiny-tinymce-importer" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-importer-check" style="width: 110px; height: 20x;" data-on="' . __( "Show", "ts_visual_composer_extend" ) . '" data-off="' . __( "Hide", "ts_visual_composer_extend" ) . '">';
												$output .= '<div class="toggle-slide">';
													$output .= '<div class="toggle-inner">';
														$output .= '<div class="toggle-on" style="">' . __( "Show", "ts_visual_composer_extend" ) . '</div>';
														$output .= '<div class="toggle-blob" style=""></div>';
														$output .= '<div class="toggle-off active" style="">' . __( "Hide", "ts_visual_composer_extend" ) . '</div>';
													$output .= '</div>';
												$output .= '</div>';
											$output .= '</div>';
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch" style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconanimation" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconanimation-check" style="width: 110px; height: 20px;" data-on="<?php _e( "Default", "ts_visual_composer_extend" ); ?>" data-off="<?php _e( "Hover", "ts_visual_composer_extend" ); ?>">
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch" style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconback" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconback-check" style="width: 100px; height: 20px" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
													<div class="toggle-off active"><?php __( "No", "ts_visual_composer_extend" ); ?></div>
												</div>
											</div>
										</div>
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch" style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconhoverchange" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconhoverchange-check" style="width: 100px; height: 20px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch" style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconborder" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconborder-check" style="width: 100px; height: 20px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch" style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconpadding" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconpadding-check" style="width: 100px; height: 20px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch" style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconmargin" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconmargin-check" style="width: 100px; height: 20px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch"style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconlink" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconlink-check" style="width: 100px; height: 20px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch" style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconinline" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconinline-check" style="width: 100px; height: 20px;" data-on="<?php __( "Yes", "ts_visual_composer_extend" ); ?>" data-off="<?php __( "No", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on active"><?php __( "Yes", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob"></div>
													<div class="toggle-off"><?php __( "No", "ts_visual_composer_extend" ); ?></div>
												</div>
											</div>
										</div>
								...
								<tr>
									...
									<td class="ts-switch-button ts-composer-switch"style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-icontooltip" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-icontooltip-check" style="width: 110px; height: 20px;" data-on="<?php _e( "Title", "ts_visual_composer_extend" ); ?>" data-off="<?php _e( "CSS3", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
					...
					<div class="ts-advanced-link-button-wrapper ts-advanced-link-tooltip-holder" style="margin: 10px 0 20px 0;">
						<span class="ts-advanced-link-tooltip-content"><?php _e("Click here to copy the generated shortcode into the browser clipboard.", "ts_visual_composer_extend"); ?></span>
						<button type="button" id="ts_tiny_clipboard_copy_shortcode" name="ts_tiny_clipboard_copy_shortcode" class="ts-advanced-link-button-main ts-advanced-link-button-orange ts-advanced-link-button-copy" data-clipboard-action="copy" data-clipboard-target="#ts_tiny_tinymce_shortcode_copy" data-error="<?php _e( "No Icon Shortcode has been generated yet.", "ts_visual_composer_extend" ); ?>" data-success="<?php _e( "Icon Shortcode has been copied to Clipboard.", "ts_visual_composer_extend" ); ?>">
							<?php _e("Copy Shortcode", "ts_visual_composer_extend"); ?>
						</button>
					</div>					
					...
					<div class="ts-advanced-link-button-wrapper ts-advanced-link-tooltip-holder" style="margin: 10px 0 0 0;">
						<span class="ts-advanced-link-tooltip-content"><?php _e("Click here to copy the generated HTML code into the browser clipboard.", "ts_visual_composer_extend"); ?></span>
						<button type="button" id="ts_tiny_clipboard_copy_html" name="ts_tiny_clipboard_copy_html" class="ts-advanced-link-button-main ts-advanced-link-button-turquoise ts-advanced-link-button-copy" data-clipboard-action="copy" data-clipboard-target="#ts_tiny_tinymce_html_copy" data-error="<?php _e( "No Icon HTML code has been generated yet.", "ts_visual_composer_extend" ); ?>" data-success="<?php _e( "Icon HTML code has been copied to Clipboard.", "ts_visual_composer_extend" ); ?>">
							<?php _e("Copy HTML Code", "ts_visual_composer_extend"); ?>
						</button>
					</div>	
				</div>				
				<?php
