	...
	<div id="ts-settings-about" class="tab-content">
		<div class="ts-vcsc-settings-group-header">
			<div class="display_header">
				<h2><span class="dashicons dashicons-editor-code"></span>Composium - Visual Composer Extensions v<?php echo TS_VCSC_GetPluginVersion(); ?> ... EnlighterJS (Syntax Highlighter)</h2>
			</div>
			<div class="clear"></div>
		</div>
		<div class="ts-vcsc-settings-group-topbar ts-vcsc-settings-group-buttonbar">
			...
			<div class="ts-vcsc-settings-group-actionbar">
				<div class="ts-advanced-link-button-wrapper ts-advanced-link-tooltip-holder ts-advanced-link-tooltip-right ts-advanced-link-tooltip-bottom">
					<span class="ts-advanced-link-tooltip-content"><?php _e("Click here to save your custom theme for the syntax highlighter.", "ts_visual_composer_extend"); ?></span>
					<button type="submit" name="Submit" id="ts_vcsc_extend_settings_submit_1" class="ts-advanced-link-button-main ts-advanced-link-button-blue ts-advanced-link-button-save" style="margin: 0;">
						<?php echo __("Save Custom Theme", "ts_visual_composer_extend"); ?>
					</button>
				</div>				
			</div>
			<div class="clear"></div>
		...
		<div class="ts-vcsc-settings-enlighterjs-main">
			<div class="ts-vcsc-section-main">
				...
				<div class="ts-vcsc-section-content">
					...
					<div class="ts-advanced-link-button-wrapper ts-advanced-link-tooltip-holder" style="margin: 0;">
						<span class="ts-advanced-link-tooltip-content"><?php _e("Click here to compile a new statistic and summary for usage of Visual Composer elements from this plugin.", "ts_visual_composer_extend"); ?></span>
						<div id="ts-enlighterjs-container-update" class="ts-advanced-link-button-main ts-advanced-link-button-orange ts-advanced-link-button-update">
							<?php _e("Update Preview", "ts_visual_composer_extend"); ?>
						</div>
					</div>					
		...
		<div class="ts-vcsc-settings-group-actionbar">
			<div class="ts-advanced-link-button-wrapper ts-advanced-link-tooltip-holder ts-advanced-link-tooltip-right">
				...
				<button type="submit" name="Submit" id="ts_vcsc_extend_settings_submit_2" class="ts-advanced-link-button-main ts-advanced-link-button-blue ts-advanced-link-button-save" style="margin: 0;">
					<?php _e("Save Custom Theme", "ts_visual_composer_extend"); ?>
				</button>
			</div>
		</div>
		<div class="clear"></div>
