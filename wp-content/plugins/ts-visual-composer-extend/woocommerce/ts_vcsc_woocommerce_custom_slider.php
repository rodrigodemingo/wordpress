													...
													$output .= '<div class="mask" style="width: 100%; display: block;">';													
														$output .= '<div id="ts-woocommerce-product-' . $product_id . '-maskcontent" class="maskcontent" style="margin: 0; padding: 0;">';
															...
															if (($show_price == "true") && ($variable == "false")) {
																...
																$output .= '<div class="ts-woocommerce-product-price">';
																	$output .= '<i style="" class="ts-woocommerce-product-icon ts-woocommerce-product-cost ts-ecommerce-pricetag3"></i>';
																	$output .= '<div class="ts-woocommerce-product-current">' . ((is_numeric(min($prices))) ? woocommerce_price(min($prices)) : min($prices)) . ' -</div><div class="ts-woocommerce-product-current" style="padding-left: 5px;">' . ((is_numeric(max($prices))) ? woocommerce_price(max($prices)) : max($prices)) . '</div>';
																$output .='</div>';
															}														
												...
												$output .= '<div class="ts-modal-white-inner">';
													...
													$output .= '<div class="ts-woocommerce-lightbox-frame" style="width: 100%; height: 32px; margin: 10px auto; padding: 0;">';
														...
														if ($variable == "false") {
															...
															$output .= '<div class="ts-woocommerce-product-current">' . ((is_numeric($min)) ? woocommerce_price($min) : $min) . ' -</div><div class="ts-woocommerce-product-current" style="padding-left: 5px;">' . ((is_numeric($max)) ? woocommerce_price($max) : $max) . '</div>';
														}
													$output .='</div>';
