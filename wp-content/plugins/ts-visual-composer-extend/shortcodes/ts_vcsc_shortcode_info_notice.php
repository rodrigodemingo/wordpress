				...
				$output .= '<div class="ts-' . $panel_layout . '-panel-field">';
					if ($icon_replace == "false") {
						if (($panel_icon != "") && ($panel_icon != "transparent")) {
							$output .= '<div class="ts-' . $panel_layout . '-panel-info-icon" style="width: ' . $panel_size . 'px; height: ' . $panel_size . 'px;"><i class="' . $panel_icon . ' ' . $animation_icon . '" style="font-size: ' . $panel_size . 'px; line-height: ' . $panel_size . 'px; height: ' . $panel_size . 'px; ' . $custom_color_icon . '"></i></div>';
						...
						if ($panel_image != "") {
							...
							$output .= '<div class="ts-' . $panel_layout . '-panel-info-icon" style="width: ' . $panel_size . 'px; height: ' . $panel_size . 'px;"><img class="' . $animation_icon . '" src="' . $panel_image[0] . '" style="width: ' . $panel_size . 'px; height: ' . $panel_size . 'px;"></div>';
							$output .= '<div class="ts-' . $panel_layout . '-panel-info-spacer" style="width: ' . $panel_spacer . 'px;"></div>';
						}
					}			
					$output .= '<div class="ts-' . $panel_layout . '-panel-info-desc">';
						...
						if (function_exists('wpb_js_remove_wpautop')){
							$output .= '<div class="ts-' . $panel_layout . '-panel-info-main" style="' . $google_font_content . '">' . wpb_js_remove_wpautop(do_shortcode($content), $wpautop) . '</div>';
						} else {
