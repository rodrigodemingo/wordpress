<?php
	...
	function TS_VCSC_Page_Background_Function ($atts) {
		...
		if ($type == "color") {
			...
			if ($frontend == "true") {
				$output .= '<div id="' . $background_id . '" class="ts-pageback-image-edit ' . $css_class . ' ' . $el_class . '" data-inline="' . $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode . '" data-image="' . $image_path . '" data-controls="' . $video_controls . '" data-raster="' . $video_raster . '">';
					...
					$output .= '<div class="ts-pageback-notes">' . __( "Background Type", "ts_visual_composer_extend" ) . ': ' . __( "Single Color", "ts_visual_composer_extend" ) . '</div>';
				$output .= '</div>';
			} else {
				$output = '<div id="' . $background_id . '" class="ts-pageback-color ' . $css_class . ' ' . $el_class . '" data-mobile="' . $allow_mobile . '" data-inline="' . $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode . '">';
					$output .= '<div class="ts-background-color-holder" style="background: ' . $background_color . ';"></div>';
		...
		if ($type == "gradient") {
			...
			if ($frontend == "true") {
				$output .= '<div id="' . $background_id . '" class="ts-pageback-gradient-edit ' . $css_class . ' ' . $el_class . '" data-inline="' . $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode . '" data-image="' . $image_path . '" data-controls="' . $video_controls . '" data-raster="' . $video_raster . '">';
					$output .= '<div class="ts-pageback-title">TS Page Background</div>';
					$output .= '<div class="ts-pageback-notes">' . __( "Background Type", "ts_visual_composer_extend" ) . ': ' . __( "Gradient Color", "ts_visual_composer_extend" ) . '</div>';
				$output .= '</div>';
			} else {
				$output = '<div id="' . $background_id . '" class="ts-pageback-gradient ' . $css_class . ' ' . $el_class . '" data-mobile="' . $allow_mobile . '" data-inline="' . $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode . '">';
					$output .= '<div class="ts-background-gradient-holder" style="background: ' . $background_gradient . ';"></div>';
					$output .= $raster_content;
				$output .= '</div>';
			}
		}
		if (($type == "image") || ($type == "featured")) {
			if ($type == "featured") {
				$fixed_image			= get_post_thumbnail_id();
			}
			if ($frontend == "true") {
