<?php
    ...
    function TS_VCSC_Widgets_Post_Help( $contextual_help, $screen_id, $screen ) { 
        if ( 'edit-ts_widgets' == $screen->id ) {
            ...
            <p>This page allows you to view or modify widget / template details. Please make sure to fill out the available boxes with the appropriate details. Widget / Template information can only be used with the Visual Composer Extensions Plugin.</p>';
        }
