  ...
  docReady( function() {
    ...
    for ( var i=0, len = elems.length; i < len; i++ ) {
      ...
      if ( jQuery ) {
        ...
        // Fix sometimes after image loaded breaks layout
...
FitRows.prototype._resetLayout = function() {
  ...
  if (this.options.equalheight && this.isotope.items) {
...
function isotopeDefinition( Outlayer, getSize, matchesSelector, Item, LayoutMode ) {
  ...
  Isotope.prototype._layout = function() {
    ...
    this.layoutTimeout = setTimeout(function() {
      // don't animate first layout
      var isInstant = that._getIsInstant();
      // layout flow
      that._resetLayout();
      that._manageStamps();
      that.layoutItems( that.filteredItems, isInstant );

      // flag for initalized
      that._isLayoutInited = true;
