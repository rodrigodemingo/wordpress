<?php
/**
 * Building form email input field with bootstrap rules
 *
 * Shortcut Method : BsEmail($context)
 *
 ...
 */
class VTCore_Bootstrap_Form_BsEmail
...
implements VTCore_Form_Interface {
  ...
  public function buildElement() {
    ...
    $this->addChildren(new VTCore_Form_Email($this->getContext('input_elements')));
