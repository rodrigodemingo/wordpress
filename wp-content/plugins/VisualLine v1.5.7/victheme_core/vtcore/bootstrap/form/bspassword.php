<?php
/**
 * Building form password with bootstrap rules
 *
 * Shortcut Method : BsPassword($context)
 *
 ...
 * meter         : (boolean) Flag to load javascript for password strength
 *
 * @author jason.xie@victheme.com
 * @method BsText($context)
 * @see VTCore_Html_Form interface
 */
class VTCore_Bootstrap_Form_BsPassword
...
implements VTCore_Form_Interface {
  ...
  public function buildElement() {
    ...
    if ($this->getContext('meter')) {
      VTCore_Wordpress_Utility::loadAsset('bootstrap-password');
      $this->addContext('input_elements.attributes.class.bspassword', 'bspassword');
    }
    ...
    $this->addChildren(new VTCore_Form_Password($this->getContext('input_elements')));
